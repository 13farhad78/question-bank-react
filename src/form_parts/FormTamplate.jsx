...
const cleanFormData = (data) => {
    ...
    if (cleanedData.basic_info) {
        cleanedData.basic_info.grade = extractValue(cleanedData.basic_info.grade);
        cleanedData.basic_info.lesson = extractValue(cleanedData.basic_info.lesson);
        cleanedData.basic_info.difficulty = extractValue(cleanedData.basic_info.difficulty);
    }

    // 2. تمیز کردن فیلدهای داخل language_skills
    if (cleanedData.language_skills && cleanedData.language_skills.focus) {
        cleanedData.language_skills.focus = extractValue(cleanedData.language_skills.focus);
    }
