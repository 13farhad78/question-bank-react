...
export const subjects = [
  ...
  { value: "Language melody", label: "Language melody" },
];
...
export const months = [
  { value: "Khordad", label: "Khordad" },
  { value: "Shahrivar", label: "Shahrivar" },
  { value: "Dey", label: "Dey" },
];

// iranian provinces data
